    ...
    return (
        <section className={styles.container} id="boards">
            ...
            <div className={styles.boardWrapper}>
                ...
                {activeBoard == 1 && <Board name="Board 1" img={"/images/board-1.jpg"} chairman="Bastiaan Bakker" secretary="Marcel Brouwers" treasurer="Frederiek Backers" commissionerIntern="Joris van Breukelen" commissionerOfInventory="Rona Roovers" commissionerOfBarkeepers="Robbin Poll" qualitateQua="Louise Zwep &amp; Joos Vrijdag"/>}
