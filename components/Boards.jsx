    ...
    return (
        <section className={styles.container} id="boards">
            ...
            <div className={styles.boardWrapper}>
                {activeBoard == 3 && <Board name="Board 3" img={"/images/board-3.jpg"} chairman="Shirley Li " secretary="Amanda Krudde" treasurer="Lars van Tol" commissionerOfInventory="Simon Molenkamp" commissionerOfEvents="Bart Zuidema" commissionerOfMaintenance="Daan Schat " qualitateQua="Niels Mateijsen &amp; Maxim Maxurovs"/>}
